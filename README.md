...
**순천대학교**에서 활동하며, 실무 중심의 앱 및 웹 서비스를 개발하는 데 주력하고 있습니다. 사용자 경험(UX)을 고려한 인터페이스 구현과 효율적인 데이터 처리에 관심이 많습니다.

- 📱 **Mobile App Development** — Flutter를 활용한 크로스 플랫폼 앱 설계 및 최적화
- 🏛️ **Student Leadership** — 순천대학교 제40대 총학생회 부회장 (대학 통합 및 교명 변경 관련 학생 의견 수렴 주도)
